                    ...
                    <form action="{{route('blog.update' , $blog->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="user_id">
                                <option value="{{$blog->blogWriter->name}}">{{$blog->blogWriter->name}}</option>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="isi_blog" class="form-control" cols="30" rows="10">
                                {{$blog->isi_blog}}
                            </textarea>
                        </div>
                        <div class="form-group">
                          <label for="isi_blog">Gambar Blog : </label>
                         <input type="file" name="image_blog" class="form-control" value="{{$blog->image_blog}}">
                      </div>
                        <div class="form-group">
                          <label for="head_image">Header Image : </label>
                         <input type="file" name="head_image" class="form-control" value="{{$blog->head_image}}">
                      </div>
